...
import CRMClientManagement from "@/components/dashboard/CRMClientManagement";
...
const allTabs = [
  ...
  { id: "clients", label: "Gestão de Clientes", icon: Users, group: "crm" },
      ...
      <main className="flex-1 transition-all duration-200" style={{ marginLeft: sidebarCollapsed ? 64 : 240 }}>
        ...
        <div className="p-6">
          <motion.div key={activeTab} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2 }}>
            ...
            {activeTab === "clients" && <CRMClientManagement />}
