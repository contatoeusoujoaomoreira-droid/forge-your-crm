      ...
      <div className="container relative z-10 text-center py-20">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-lime/20 bg-lime/5 text-lime text-sm font-medium mb-8">
            ...
            Plataforma All-in-One de Marketing & Vendas
          </div>

          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight max-w-5xl mx-auto">
            CRM, Landing Pages, Quiz, Forms, Agenda e Checkout{" "}
            <span className="text-gradient-lime">em um só lugar.</span>
          </h1>

          <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Capture leads, construa funis, crie páginas profissionais, agende reuniões e venda online — tudo com IA integrada e sem precisar de código.
          </p>
        ...
        >
          {[
            ...
            <div key={stat.label} className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-gradient-lime">{stat.value}</div>
